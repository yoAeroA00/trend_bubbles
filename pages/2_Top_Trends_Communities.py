from Home import css, get_trends, update_analysis, run_analysis, update_community_frontend
import json
import pandas
...
graph_height = '900px'
hashtag_charts_limit = 60
users_charts_limit = 60
tweets_charts_limit = 60
...
with st.spinner('Loading Analysis from Database ...'):
    update_community_frontend(graph_height, hashtag_charts_limit, users_charts_limit, tweets_charts_limit, analysis_folder)
